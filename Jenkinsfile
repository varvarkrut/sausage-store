pipeline {
    ...
    stages {
       ...
       stage('Notify'){
            steps {
            sh """
            curl -X POST -H 'Content-type: application/json' --data '{"text":"Шкурко Иван собрал приложение."}' https://hooks.slack.com/services/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
            """
            }
